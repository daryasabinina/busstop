var $$FSR = {
  ...
  'embedded': false,
  'replay_id': 'consumerreports.org',
  'site_id': 'consumerreports.org',
  'attach': false,
  'renderer': 'W3C',
  // or "ASRECORDED"
  'layout': 'CENTERFIXED',
 ...
 */
  FSR.properties = {
    ...
    invite: {
      ...
      exclude: {
        urls: window.foreseeExcludes,
        referrers: [],
        userAgents: [],
        browsers: [],
        cookies: [{
          name: 'suppressForeSeeModal',
          value: 'true'
        }],
        variables: [{
          name: 'window.isCroPaywall',
          value: 'true'
        }]
      },
      include: {
